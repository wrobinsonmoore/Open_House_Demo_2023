...
public class LineChart_2_normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linechart_2_normal);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.histo_15_normal_blue);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.histo_15_normal_blue);
        }
...
//                grtv.setText("You swiped up with " + fingers + " finger(s).");
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(LineChart_2_normal.this, GraphSelector.class);
    ...
    public void logger(String file_name) throws IOException {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (ContextCompat.checkSelfPermission(LineChart_2_normal.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(LineChart_2_normal.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
                else {
